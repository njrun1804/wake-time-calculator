...
describe('Planner HTML Structure', () => {
  ...
  test('should call setupBrowseViewEventListeners in setupAllEventListeners', () => {
    const setupMatch = htmlContent.match(/function setupAllEventListeners\(\)[\s\S]*?setupBrowseViewEventListeners\(\)/);
